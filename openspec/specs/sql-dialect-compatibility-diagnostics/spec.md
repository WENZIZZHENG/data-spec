# sql-dialect-compatibility-diagnostics Specification

## Purpose
Defines deterministic PostgreSQL/MySQL dialect capability diagnostics for AI, CLI, API, and frontend consumers.
