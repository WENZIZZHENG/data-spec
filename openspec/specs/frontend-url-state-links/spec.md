# frontend-url-state-links Specification

## Purpose
Define the non-sensitive URL query protocol used by DataSpec Web to restore high-frequency workflow state, copy reproducible operation links, and recover safely from invalid route parameters.
## Requirements
