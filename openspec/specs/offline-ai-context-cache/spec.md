# offline-ai-context-cache Specification

## Purpose
Define the repository-local AI Context cache layout, freshness metadata, and offline read-only boundary for AI agents working in business repositories.
