# fixedsql-file-patch-flow Specification

## Purpose
Describe the local fixedSql file patch workflow that lets AI agents and users preview, verify, and explicitly apply SQL lint fixes to repository SQL files.
