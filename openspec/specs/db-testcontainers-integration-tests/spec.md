# db-testcontainers-integration-tests Specification

## Purpose
定义 DataSpec 如何通过可选 Testcontainers 集成测试验证 PostgreSQL/MySQL 元数据、compare、coverage 和只读安全诊断链路，同时保持默认单元测试不依赖 Docker。
## Requirements
