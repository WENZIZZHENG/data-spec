...
function navigationCommands(projectId: number | null): CommandPaletteItem[] {
  ...
  return [
    ...
    requiresProject({ id: 'page.standard-qa', title: '标准问答', description: '用自然语言查询标准字段和证据引用', group: 'navigation', keywords: ['qa', 'question', 'answer', '标准问答', '证据'], route: { path: '/standard-qa', query: projectQuery } }),
