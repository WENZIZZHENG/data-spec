...
test('defines shared stable selectors for high-frequency browser workflows', () => {
  ...
  const requiredIds = [
    ...
    stableTestIds.standardCandidates.page,
    stableTestIds.standardCandidates.tokenEvidenceButton,
    stableTestIds.standardCandidates.tokenEvidenceDialog,
    stableTestIds.standardCandidates.previewButton,
    stableTestIds.standardCandidates.applyButton,
