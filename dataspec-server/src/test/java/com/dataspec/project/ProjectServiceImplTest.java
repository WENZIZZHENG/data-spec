...
class ProjectServiceImplTest {
    ...
    void create_importsBuiltInStandardsByDefault() {
        ...
        ProjectServiceImpl service = new ProjectServiceImpl(projectRepository, standardsImportService, ruleBaselineService);
        ...
        verify(ruleBaselineService).applyBuiltInBaseline(7L, BuiltInRuleBaselines.PERSONAL_DEFAULT, false);
    }
